...
if green
gr.color 255,0,255,1
else
gr.color 255,255,0,1
endif
!small=1
...
mymonth=val(month$)
myday=val(day$)
if myminutes>val(right$(left$(f$,10),2))
b$="Confirmed "+str$(myminutes-val(right$(left$(f$,10),2)))+" minutes ago."
gr.text.draw mid,0.03*w,0.7*l,b$
fn.rtn mid
fn.end
